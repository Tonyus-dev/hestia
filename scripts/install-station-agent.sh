...
for file in codice.js codiceAuth.js codiceReadOnlyRoutes.js config.js dataDir.js events.js legacyStorageConfig.js retention.js security.js services.js stationAgent.js stationClient.js stationDoctor.js systemStatus.js storage.js storageModel.js storageScanner.js storageSources.js updates.js; do
