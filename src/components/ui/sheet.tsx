...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/70 backdrop-blur-[2px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:duration-[380ms] data-[state=closed]:duration-[240ms] ease-[cubic-bezier(0.22,1,0.36,1)]",
      className,
    )}
    {...props}
    ref={ref}
